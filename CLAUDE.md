...
The BFF post (`_posts/2026-03-22-build-friction-fix.md`) is the reference point. That post *is* the voice, not aspirational, the actual thing. It took many rounds of editing (its own BFF loop) to get there. When in doubt, read it and match that energy.
...
- **Stream-of-consciousness with structure.** Loose and personal, but with named frameworks and sticky phrases (BFF, cosmic farmland, fitfo). The rawness is the point.
- **Lowercase-intentional.** Titles, tone, energy. Not casual-by-accident but informal-by-choice.
- **Wide-ranging connections.** English and economics double major. Far-flung literary, philosophical, and cross-domain references (Yeats, fractals, slow food movement) are a feature, not a reach. The resonance is enough.

### What's different from professional writing
- **Rawer.** Ideas can be half-formed. Friction is shown, not hidden. Brain dumps are part of the content.
...
- **Repetition for rhythm.** Core ideas repeated in different forms for emphasis. Three variations is emphasis, five is a TED talk.
