...
[lazar jovanovic talks about this](https://www.lennysnewsletter.com/p/getting-paid-to-vibe-code) with his debugging workflow. when something breaks, he steps through layers: let the tool try, then bring your own awareness, then bring in an external tool, then check if it's your fault. and when the fix lands, he asks the tool:
